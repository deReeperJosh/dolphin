...
const std::map<const std::pair<const u16, const u16>, SkyData> list_skylanders = {
    ...
    {{218, 0x3000}, {"Dark Dagger", Game::TrapTeam, Element::Dark}},
    {{218, 0x3014}, {"Shadow Spider", Game::TrapTeam, Element::Dark}},
    {{218, 0x301A}, {"Ghastly Grimace", Game::TrapTeam, Element::Dark}},
    {{219, 0x3000}, {"Shining Ship", Game::TrapTeam, Element::Light}},
    {{219, 0x300F}, {"Heavenly Hawk", Game::TrapTeam, Element::Light}},
    {{219, 0x301B}, {"Beam Scream", Game::TrapTeam, Element::Light}},
    ...
    {{482, 0x0000}, {"Knight Light", Game::TrapTeam, Element::Light}},
    {{483, 0x0000}, {"Spotlight", Game::TrapTeam, Element::Light}},
    {{484, 0x0000}, {"Knight Mare", Game::TrapTeam, Element::Dark}},
    {{485, 0x0000}, {"Blackout", Game::TrapTeam, Element::Dark}},
    ...
    {{3236, 0x0000}, {"Sun Runner", Game::Superchargers, Element::Light}},
    {{3236, 0x4403}, {"Legendary Sun Runner", Game::Superchargers, Element::Light}},
    {{3237, 0x0000}, {"Sea Shadow", Game::Superchargers, Element::Dark}},
    {{3237, 0x4402}, {"Dark Sea Shadow", Game::Superchargers, Element::Dark}},
    ...
    {{3426, 0x0000}, {"Astroblast", Game::Superchargers, Element::Light}},
    {{3426, 0x4503}, {"Legendary Astroblast", Game::Superchargers, Element::Light}},
    {{3427, 0x0000}, {"Nightfall", Game::Superchargers, Element::Dark}},
